...
import { DetailContainer, HomeContainer, ImageDetail, ContentDetail, TextDetail } from './EventDetailsStyled';
			...
			<Content className="cl-content">
				{event && (
					<Fragment>
						<PageHeaderDetail
							title={event['title']}
							professor={event['professor']['fullName']}
						...
						<HomeContainer>
							<CustomCard
								headerCard={'Details'}
								stylesCustom={{ fontSize: '1.3em', fontWeight: 'bold', minWidth: '30%' }}
							>
								<DetailContainer>
							...
							<CustomCard
								...
								stylesCustom={{ fontSize: '1.2em', fontWeight: 'bold', minWidth: '30%' }}
							>
								...
								<List
									...
									renderItem={(item) => (
										<List.Item key={item.id}>
											<List.Item.Meta avatar={<EditOutlined />} title={<p>{item.value}</p>} />
										</List.Item>
									)}
								/>
							</CustomCard>
